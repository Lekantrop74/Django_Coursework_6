...
urlpatterns = [
    ...
    path('', cache_page(60)(home_page), name='home_page'),
    ...
    path("client_card/<slug:slug>", cache_page(60)(ClientsDetailView.as_view()), name="client_card"),
    ...
    path("message_detail/<slug:slug>", cache_page(60)(MessagesDetailView.as_view()), name="message_detail"),
    ...
    path("transmission_detail/<slug:slug>", cache_page(60)(TransmissionDetailView.as_view()), name="transmission_detail"),
